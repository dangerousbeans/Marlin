...
#define STRING_CONFIG_H_AUTHOR "@donekscience" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "[Spike] Marlin v2.0"
...
// Resistor values when using MAX31865 sensors (-5) on TEMP_SENSOR_0 / 1
  ...
  #define TEMP_COOLER_RESIDENCY_TIME 10  // (seconds) Time to wait for cooler to "settle" in M192
  #define TEMP_COOLER_WINDOW          1  // (°C) Temperature proximity for the "temperature reached" timer
...
//
// 480x272, 4.3// 480x272, 4.3", FSMC Display From MKS
// Usually paired with MKS Robin Nano V1.2
//
...
/**
 * Marlin supports the open-source community by allowing you to add
 * a custom boot image for Graphical LCDs.
 *
 ...
 *
 * To use a custom boot image, place a file called _Bootscreen.h in the
 * root directory of your Marlin source code. This file should contain
 * a 128x64 bitmap in .xbm format.
 *
 * For the standard Marlin boot screen, leave this option enabled.
 */
//#define SHOW_BOOTSCREEN

/**
 * Show the bitmap in Marlin/_Bootscreen.h on startup.
 * If you have a custom boot image, disable this option.
 */
//#define SHOW_CUSTOM_BOOTSCREEN

/**
 * Show the bitmap in Marlin/_Statusscreen.h on the status screen.
 * If you have a custom status screen image, disable this option.
 */
 ...
 * Show the bitmap in Marlin/_Bootscreen.h on startup.
 * If you have a
 * * custom boot image, disable this option.
 */
//#define SHOW_CUSTOM_BOOTSCREEN
 ...
 * Watchdog Timer
 *
 * Marlin supports the use of a watchdog timer to protect against firmware
 * lockups and other conditions that can cause the printer to become unresponsive.
 * If the watchdog timer is enabled, Marlin will periodically reset the watchdog
 * timer to prevent it from restarting the printer. If Marlin fails to reset the
 * watchdog timer within the specified timeout period, the watchdog timer will
 * trigger a reset of the printer.
 *
 * Enable the watchdog timer to improve the reliability and safety of your printer.
 */
//#define USE_WATCHDOG

#if ENABLED(USE_WATCHDOG)
  //#define WATCHDOG_RESET_MANUAL   // Manually reset the watchdog timer in the firmware
  //#define WATCHDOG_RESET_AUTO     // Automatically reset the watchdog timer (default)
#endif

// @section advanced

/**
 * Advanced settings can be configured in Configuration_adv.h
 *
 * The Configuration_adv.h file contains advanced settings that allow you
 * to fine-tune the behavior of your printer. These settings include options
 * for acceleration, jerk, stepper motor current, and more.
 *
 * To access and modify these settings, open the Configuration_adv.h file
 * in a text editor and make the necessary changes. Be sure to save your
 * changes and recompile the firmware before uploading it to your printer.
 *
 * For more information on the available settings and their usage, refer to
 * the Marlin documentation at https://marlinfw.org/docs/configuration/configuration.html
 */
 ...
 *
 * This concludes the basic configuration for your Marlin firmware.
 * Be sure to review and adjust the advanced settings in Configuration_adv.h
 * as needed to further customize your printer's behavior.
 *
 * Once you have completed all necessary configuration changes, save the
 * Configuration.h and Configuration_adv.h files, recompile the firmware,
 * and upload it to your printer.
 *
 * For more information and support, visit the Marlin website at https://marlinfw.org
 * or join the Marlin community on GitHub at https://github.com/MarlinFirmware/Marlin
 *
 * Happy printing!
 */